...
export default function Login() {
    ...
    const [chatPartnerName, setChatPartnerName] = useState(''); // State for chat partner name
    ...
    const handleSubmit = async (e) => {
        ...
        if (response.ok) {
            ...
            localStorage.setItem('chatPartner', chatPartnerName);
                ...
                <div className="w-full ">
                    ...
                    <form onSubmit={handleSubmit}>
                        ...
                        <input
                            ...
                            onChange={(e) => setChatPartnerName(e.target.value)}
                            placeholder="Your Chat Partner's Name"
                            required
                            className="form-control mb-3"
                        />
