...
//   <div>
//     <Header/>
//     <div className='container bg-gray-800 mx-auto mt-3 max-w-screen-lg rounded-lg p-6 shadow-lg h-screen'>
...
//  className="border border-gray-300 text-black p-2 rounded-lg mb-4 "/>
// <div className='font-bold mb-4 text-center text-black'>
// <Link href="/chat" className="btn btn-secondary">new chat</Link>
// </div>
// </div>

// <ul className="space-y-2  overflow-y-auto max-h-screen">
  
//         {chatHistory.map((msg, index) => (
          
//           <li key={index} className="bg-gray-700  p-3 rounded-lg shadow ">
//             <span className="font-serif mr-2">{msg.sender}:</span>
//             <div className="font-extrabold italic">{msg.text}{console.log("working")}</div>
//             {msg.file && (
//               <div>
    ...
    <div>
      ...
      <div className="container bg-gray-800 mx-auto mt-3 max-w-screen-lg rounded-lg p-6 shadow-lg h-screen flex flex-col">
        ...
        <div className="flex justify-between mb-4">
          ...
          <Link href="/Group-chat" className="btn btn-secondary text-black bg-white font-bold py-2 px-4 rounded-lg">
            New Group Chat
          </Link>
          </div>
        </div>
